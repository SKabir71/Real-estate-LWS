...
import FaqDown from "../svg/FaqDown";
import FaqSvg from "../svg/FaqSvg";
import FaqUp from "../svg/FaqUp";

const FAQ = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white dark:bg-dark  pb-8 pt-20  lg:pb-[50px] lg:pt-[120px]">
